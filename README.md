...
This repository contains the highly optimized, native **Linux** build of Zero Mail. It is engineered from the ground up to utilize native Linux windowing and graphics APIs for zero-latency input and maximum performance, aiming to outperform industry standards.
...
```bash
git clone https://github.com/Suraj-Mavuleti/zero-mail-linux.git
cd zero-mail-linux
make build-linux
```
